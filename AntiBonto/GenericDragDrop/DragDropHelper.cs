    ...
    public class DragDropHelper
    {
        ...
        private void DragSource_PreviewMouseLeftButtonDown(object sender, MouseButtonEventArgs e)
        {
            try
            {
                ...
                _adornerLayer = (Canvas)_topWindow.FindName(adornerLayerName) ?? new Canvas { Visibility = Visibility.Collapsed };
        ...
        private void DragSource_PreviewMouseMove(object sender, MouseEventArgs e)
        {
            if (!_mouseCaptured && _draggedData != null)
            {
                ...
                if (DragDropHelper.IsMovementBigEnough(_initialMousePosition, e.GetPosition(_topWindow)))
                {
                    ...
                    var parent = _adorner.Parent as Panel;
                    if (parent != null)
                        parent.Children.Remove(_adorner);
